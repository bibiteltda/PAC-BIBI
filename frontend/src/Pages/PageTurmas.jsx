...
import LinkConvite from "../Components/PageTurmas/LinkConvite"; // ✅ Import da sidebar
...
//     const escolasDisponiveis = useMemo(() => ["todas", ...new Set(turmasMock.map((t) => t.escola))], []);
...
//                     <main className="flex-1 flex justify-center items-start bg-[#F3F4F6] p-5 lg:p-8 overflow-y-auto">
//                         <div className="w-full max-w-[800px] flex flex-col space-y-6">
//                             <h1 className="text-3xl font-bold text-center">Turmas</h1>
...
//             {/* Sidebar lateral (Link de Convite) */}
//             <AnimatePresence>
//                 {turmaSelecionada && (
//                     <>
//                         {/* Overlay */}
